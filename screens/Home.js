            ...
            <View style={styles.container}>
                ...
                <ImageBackground source={require('../assets/stars.gif')} style={styles.backgroundImage}>
                    ...
                    <TouchableOpacity style={styles.routeCard} onPress={()=>{
                        ...
                        <Image style={styles.routeImage} source={require('../assets/space_crafts.png')} />
                    </TouchableOpacity>
                    ...
                    <TouchableOpacity style={styles.routeCard} onPress={()=>{
                        ...
                        <Image style={styles.routeImage} source={require('../assets/star_map.png')} />
                    </TouchableOpacity>
                    ...
                    <TouchableOpacity style={styles.routeCard} onPress={()=>{
                        ...
                        <Image style={styles.routeImage} source={require('../assets/daily_pictures.png')} />
                    </TouchableOpacity>
                </ImageBackground>
            </View>
        );
